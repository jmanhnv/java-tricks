/*
 * FILENAME FileUpload.java FILE LOCATION $Source$ VERSION $Id$
...
/**
 * This class is used to upload a file to a FTP server. File Upload and Download Code Example.
 * 
 * @see http://www.javabeat.net/file-upload-and-download-using-java/
 * @author Muthu
 */
public class FileUpload {
	 ...
	 *            , Optional password for user.
	 * @param fileName
	 *            , Name of file to download (with optional preceeding relative path, e.g. one/two/three.txt).
	 * @param destination
